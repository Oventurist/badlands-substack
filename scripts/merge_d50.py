...
SLUGRAW = "badlands-news-brief-d50"
RAW = "raw/%s.md" % SLUGRAW
REFTITLE = 'Badlands Brief — "Kamala\'s Coming Out Party is Kinda Lame ...", URL: https://badlands.substack.com/p/badlands-news-brief-d50'
TODAY = "2026-08-06"
...
def merge(slug, body_path):
    ...
    if "## References" in txt:
        ...
        if not any(SLUGRAW in l for l in reflines):
