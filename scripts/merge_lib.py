...
RAW = 'badlands-news-brief-bd2'
REF = 'Badlands Media \u2014 "Badlands News Brief: Abstract Portraits, Real Bears, & Free Game Classes", URL: https://badlands.substack.com/p/badlands-news-brief-bd2'
...
def merge(path, body):
    ...
    entry = 'raw/%s.md' % RAW
    if entry in items:
        n = items.index(entry) + 1; new = False
    else:
