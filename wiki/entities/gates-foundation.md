...
The Gates Foundation is the roughly $77 billion philanthropic organization associated with [[bill-gates|Bill Gates]], generally known for supporting global health initiatives.[1]

## 2025 break with Arabella Advisors

In late June 2025 the foundation decided to stop funding grants to nonprofits that work with the Washington, D.C.-based consultancy [[arabella-advisors|Arabella Advisors]], according to an internal announcement obtained by the New York Times.[1] Executives said the foundation would make no new investments with "Arabella-related entities," would not extend existing grants to the for-profit consulting firm, and would even attempt to "pursue early exits" from several long-term investments.[1] The stated rationale was a desire to engage more directly with grant recipients and to reduce the use of intermediaries: the June 24 announcement said teams were "increasingly working directly with programmatic partners — organizations that are deeply embedded in the communities we serve and [are] closely aligned with our mission."[1]
