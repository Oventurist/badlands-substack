...
updated: 2026-08-02
type: entity
tags: [military, technology, surveillance, government-agency]
...
## Alleged relationship with the CIA

Carlson's central claim is that the [[cia|Central Intelligence Agency]] has in some cases taken technology created by DARPA and used it to influence Americans and monitor their activity. Because Americans would not knowingly hand their data to an intelligence agency, the article asserts, the CIA "creates companies and assigns people to be the faces of the companies." Under this framing the consumer technology sector functions as a delivery mechanism for capabilities first developed under defense contract.

The most specific example offered is [[darpa-lifelog|LifeLog]], a project of DARPA's Information Processing Techniques Office intended to compile a comprehensive electronic record of every activity and relationship in a person's life. The article also suggests that DARPA "probably created SIRI," the voice assistant later shipped by [[apple-inc|Apple]].
