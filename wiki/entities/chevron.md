...
updated: 2026-08-02
type: entity
tags: [energy, oil, lobbying, atlantic-council, ukraine]
...
As a precedent, the article cites Chevron's activity in Ukraine, where the company signed $10 billion deals with [[naftogaz]], Ukraine's state-owned oil and gas company. The firms "basically wanted to do the same deal, only on a much larger scale, with Iran." The article further notes that [[blackrock]] holds considerable — if not majority — equity stakes in Chevron and its peers, all of which stood to gain tremendously from the [[joint-comprehensive-plan-of-action|Iran Deal]].
