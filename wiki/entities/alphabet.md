...
updated: 2026-08-06
type: entity
tags: [google, alphabet, big-tech, cia, search]
sources: [raw/america-has-a-cia-run-economy.md, raw/badlands-brief-bb1.md, raw/badlands-news-brief-006.md, raw/badlands-news-brief-024.md]
confidence: medium
---
...
Google, together with [[amazon|Amazon]], Meta and [[microsoft|Microsoft]], was reported to be guiding toward $600–700 billion in combined capital expenditure for 2026, much of it flowing into data-center and AI infrastructure even as electricity constraints became apparent.[2] Badlands contributor [[burning-bright|Burning Bright]] contrasted this hyperscaler spending with Beijing's state-directed [[china-ai-data-center-buildout|AI data center buildout]].[2]

## Role in the 2023 Google antitrust trial

As Google's corporate parent, Alphabet was directly implicated in the antitrust trial that opened in September 2023 over Google's search engine dominance, described as the biggest such U.S. case since the [[microsoft|Microsoft]] litigation of the late 1990s.[3] Alphabet chief executive Sundar Pichai, who succeeded [[google|Google]] co-founder [[larry-page|Larry Page]] in 2019, was expected to be among the most prominent witnesses in the ten-week trial before U.S. District Judge Amit Mehta.[3] See [[united-states-v-google-antitrust-trial]].[3]


## Epstein subpoena service (2023)

In May 2023, prosecutors for the [[us-virgin-islands|US Virgin Islands]] asked a federal court to allow them to serve a subpoena on Google co-founder [[larry-page|Larry Page]] through Alphabet, Google's parent company, after failing to locate him physically; Page remained a member of the Alphabet board at the time.[4] The subpoena related to litigation alleging that [[jpmorgan-chase|JPMorgan Chase]] enabled [[jeffrey-epstein|Jeffrey Epstein]]'s sex-trafficking ring.[4]
