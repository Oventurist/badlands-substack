...
In the November 7, 2025 roundup "A Look At Recent Features", the Forum appears in the excerpt for [[matthew-ehret|Matthew Ehret]]'s feature "On Ted Kaczynski and False Prophets," which speaks of "the leading oligarchists running the World Economic Forum and [[great-reset|Great Reset]] today." The phrasing identifies the WEF with an identifiable elite stratum — "oligarchists" — and links it directly to the Great Reset program.

The same excerpt asserts that these figures share "common axioms" with [[ted-kaczynski|Ted Kaczynski]], the Unabomber: that is, a shared hostility to industrial civilization and to the premise of open-ended human material progress. In this reading, the WEF's decarbonization and degrowth agendas are not a break with anti-technological extremism but a boardroom expression of it. This connects to the companion Ehret features listed in the same brief, "Combating the Transhumanist Religion" and "The Rising Scourge of Eco-Terrorism," which describe coordinated "above ground" and "below ground" movements working toward what the author calls "the willful self-destruction of industrial civilization."

## In the media ownership critique

A Swan Song for the MSM names the World Economic Forum, alongside the [[council-on-foreign-relations|Council on Foreign Relations]], as one of the "elitist policy think tanks" at which representatives of the asset managers that jointly own the major media conglomerates - [[blackrock|BlackRock]], [[vanguard-group|Vanguard]], [[state-street|State Street]] and [[berkshire-hathaway|Berkshire Hathaway]] - "remain regular fixtures." The article uses this overlap to argue that the six dominant media groups function collectively as "the propaganda arm of the big 1-the Western establishment, the system of systems."

## Strategic partnership with McKinsey

A Time to Strike (October 11, 2023) identifies [[mckinsey-and-company|McKinsey & Company]] as the strategic partner of the World Economic Forum, using that relationship to argue that the consultancy's [[future-of-work|future of work]] projections — including the estimate that up to 375 million workers, 14 percent of the global workforce, would have to switch occupational categories by 2030 — represent a design for the global labor market rather than a neutral forecast. The essay links the resulting displacement, together with declining birth rates and insolvent pensions, to groundwork for the [[great-reset|Great Reset]].

## In the Global Harmony Consortium scenario

In AI Can Help Us Expose the NWO, the WEF is one of the NGOs and initiatives [[justin-deschamps|Justin Deschamps]] instructed [[chatgpt|ChatGPT]] to fold into its fictional cabal, the Global Harmony Consortium, alongside the [[world-health-organization|World Health Organization]], [[united-nations|the United Nations]] and the [[esg|ESG]] system. A follow-up prompt added [[klaus-schwab|Klaus Schwab]]'s [[great-reset|Great Reset]] as a further instrument of the scenario's strategy.
