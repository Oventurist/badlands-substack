...
An October 2025 Financial Times essay argued that the global economy faces a profound imbalance, with capital pooling in a handful of markets while vast reserves of human potential in developing countries remain underutilised.[2] Over the following decade, 1.2 billion young people — mostly in emerging and developing economies — will enter the workforce, while current economic structures will generate only 420 million new jobs, a gap the piece framed not merely as a development challenge but as a structural risk that strains political systems, fuels migration, and exposes the fragility of global supply chains.[2]

The essay contended that the scale of the challenge demands a fundamental evolution in how the World Bank and other multilateral institutions connect private capital with development aims, noting that institutional investors managing $400 trillion allocate only a fraction to markets where 85 per cent of humanity lives — a result it described as systemic risk rather than merely missed opportunity.[2]
