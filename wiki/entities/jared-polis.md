...
updated: 2026-08-05
type: entity
tags: [colorado, democratic-party, clemency, tina-peters, governor]
sources: [raw/badlands-brief-174.md, raw/badlands-brief-5a2.md]
confidence: medium
contested: true
---
...
## Commutation granted (May 2026)

The May 18, 2026 [[badlands-brief-5a2|Badlands Brief]] reports that Polis followed through on that signal, commuting [[tina-peters|Tina Peters]]' sentence on Friday, May 15, 2026. Peters was expected to be released after serving about two years in prison. Polis said the commutation reflected concerns that Peters, a first-time nonviolent offender, received an unusually severe sentence, and that the decision did not endorse her conduct or false claims about the 2020 election. Badlands contributor [[ashe-in-america|Ashe in America]] reported that the clemency took the form of a reduced sentence and grant of parole — Polis cut the sentence in half, moved up her eligibility date, and granted parole, with conditions to be determined by a governor-appointed parole board.
