...
sources: [raw/badlands-brief-0fb.md, raw/badlands-brief-143.md, raw/badlands-brief-285.md, raw/badlands-brief-311.md]
confidence: medium
contested: true
---
# Bezalel Smotrich
...
According to the source, Smotrich has called for Israel to formally expand its borders to include all of Palestine along with parts of [[lebanon|Lebanon]] and Syria. His stated justification is that Israel's current borders do not offer topography that is easy to defend, making expansion a security necessity. The Badlands commentary responds that carrying out such a program would mean erasing entire villages from the map and driving thousands of people from their homeland, and notes accompanying reporting that Israel has already destroyed over 62,000 structures, including apartments and single-family homes.

The position is presented in the source as part of the maximalist strand of Israeli policy — associated in Badlands writing with the [[greater-israel-project|Greater Israel]] concept — that the authors argue President [[donald-trump|Donald Trump]] is quietly working around rather than endorsing.
