...
## Acquisition history and the Smartmatic code lineage

[[badlands-brief-25c|Badlands Brief: Elections are Fake; as is Trump's Friendship with Bibi]] presents a detailed account, attributed to [[canncon|CannCon]] and summarized by [[ashe-in-america|Ashe in America]], of how Dominion came to hold assets derived from [[smartmatic|Smartmatic]] intellectual property. In 2010 the [[department-of-justice|Department of Justice]] under Attorney General [[eric-holder|Eric Holder]] required [[election-systems-and-software|Election Systems & Software]] to divest [[premier-election-solutions|Premier Election Solutions]] to a department-approved buyer; that buyer was Dominion. A few months later Dominion also acquired [[sequoia-voting-systems|Sequoia Voting Systems]], which a 2008 Delaware court filing had shown was still using Smartmatic's intellectual property. Dominion's press release stated it had acquired "Sequoia's inventory and all intellectual property, including software, firmware and hardware, for Sequoia's precinct and central count optical scan and DRE voting solutions," covering a vendor serving "nearly 300 jurisdictions in 16 states."
