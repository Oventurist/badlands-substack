...
Dominion Voting Systems is an election technology vendor whose equipment was at the center of the criminal case against former Mesa County Clerk [[tina-peters|Tina Peters]] in Colorado.[1]

In the March 2026 dispute over clemency for Peters, her attorney [[john-case|John Case]] described Colorado election official Matt Crane as a "Dominion Voting Systems shill," grouping him with Secretary of State [[jena-griswold|Jena Griswold]] and Attorney General [[phil-weiser|Phil Weiser]] as officials who publicly demanded that Governor [[jared-polis|Jared Polis]] deny Peters any mercy.[1] The framing reflects the broader Badlands position that Peters was prosecuted not for forgery-adjacent conduct as such, but for investigating the integrity of the voting systems used to administer elections.[1]

## Corporate origins and the Smartmatic IP lineage

Badlands Media's June 9, 2026 Brief traced Dominion's rise to a 2010 antitrust action in which the [[department-of-justice|Department of Justice]] under Attorney General [[eric-holder|Eric Holder]] forced [[election-systems-software|Election Systems & Software]] to divest [[premier-election-solutions|Premier Election Solutions]], the former Diebold subsidiary ES&S had purchased six months earlier.[2] The DOJ required divestiture of "all of the intellectual property associated with all versions — past, present, and in development — of the Premier voting equipment systems," a perpetual license to the AutoMARK ballot marking device, and sale only to a buyer approved by the department; that approved buyer was Dominion.[2]

A few months after acquiring Premier, Dominion also purchased [[sequoia-voting-systems|Sequoia Voting Systems]], which had been owned by [[smartmatic|Smartmatic]] and which, per an April 2008 Delaware Court filing, was still using Smartmatic's intellectual property.[2] Dominion's own press release announced that it had acquired Sequoia's assets — "a major U.S. provider of voting solutions serving nearly 300 jurisdictions in 16 states" — including "all intellectual property, including software, firmware and hardware, for Sequoia's precinct and central count optical scan and DRE voting solutions."[2]

In a letter to the National Institute of Standards and Technology, [[john-c-bonifaz|John C. Bonifaz]] argued that "Dominion, Now the Largest or Second Largest Voting System Company, Is Foreign Controlled and Depends Upon Secret Source Code Created and Owned by Smartmatic, a Foreign Controlled Company With Ties to The Venezuelan Government Led by Hugo Chavez," adding that Dun & Bradstreet reported Dominion as a Toronto-based company with a single listed key official, [[john-poulos|John Poulos]], and under $18 million in sales from which it obtained no income.[2] Badlands concludes that Smartmatic intellectual property is "ostensibly present throughout the system, despite its hot potato M&A activity."[2]

## Acquisition, rebranding, and end of the Lindell case

In October 2025, former Republican election official [[scott-leiendecker|Scott Leiendecker]] acquired Dominion and rebranded the company as [[liberty-vote|Liberty Vote]].[3] The new ownership declined to pursue further recovery from [[mike-lindell|Mike Lindell]], whom Dominion had sued in February 2021 for $1.3 billion over claims that its machines rigged the 2020 presidential election.[3] In June 2026, Liberty Vote Holdings, [[mypillow|My Pillow, Inc.]], a Dominion subsidiary, and Lindell filed a joint stipulation in federal court in Washington, D.C., dismissing all claims and causes of action with prejudice, meaning they cannot be refiled, with each party bearing its own attorneys' fees and costs.[3] [[smartmatic|Smartmatic]], which had earlier obtained sanctions against Lindell exceeding $92,000, was not a party to the dismissal agreement.[3]

Badlands contributor [[ashe-in-america|Ashe in America]] observed that the only apparently remaining Dominion — now Liberty Vote — defamation action was the company's case against [[patrick-byrne|Patrick Byrne]], and questioned whether it would be litigated to a revelation or quietly settled.[3]

## Fox News defamation settlement (2023)

Dominion filed a defamation suit against [[fox-news|Fox News]] in 2021 seeking $1.6 billion in damages, alleging the network was liable for airing false claims that the Denver-based company's ballot-counting machines had been used to manipulate the 2020 presidential election in favor of [[joe-biden|Joe Biden]] over [[donald-trump|Donald Trump]].[4] On April 18, 2023, with a jury already selected in Wilmington, Delaware and opening statements imminent, Fox settled for $787.5 million — described by legal experts as the largest settlement ever struck by an American media company.[4] Chief executive [[john-poulos|John Poulos]] called the outcome "historic," saying Fox "has admitted to telling lies about Dominion that caused enormous damage to my company, our employees and our customers."[4] The episode is treated in detail at [[fox-dominion-defamation-settlement|the Fox–Dominion defamation settlement]].[4]

## Texas scrutiny over the Carlson firing (May 2023)

In May 2023, Dominion's $787.5 million defamation settlement with [[fox-news|Fox News]] drew fresh political scrutiny after reports that the network had fired [[tucker-carlson|Tucker Carlson]] as part of the deal.[5] Attorneys for Carlson reportedly sent Fox News a letter accusing the network of breach of contract and fraud and alleging that his removal was a term of the Dominion settlement.[5] Texas Governor [[greg-abbott|Greg Abbott]] responded by saying that if Dominion wished to do business with Texas in future, it should "first answer questions about what role, if any, they played in silencing a prominent conservative journalist," and that those answers should guide whether the state permits the company to operate there.[5] [[ashe-in-america|Ashe in America]] wrote that of all the disclosures emerging from the Fox–Carlson dispute, none was more significant than the role Dominion played in Fox's decision to part with its most profitable prime-time talent.[5]

## Settlement fallout at Fox News

On May 9, 2023, [[tucker-carlson|Tucker Carlson]]'s legal team said a member of the [[fox-news|Fox]] board had told him that his abrupt removal from the network's air in April 2023 was part of the [[fox-dominion-defamation-settlement|settlement with Dominion]] over claims made in 2020 about the role of the company's voting machines in the presidential election.[6] The account, first reported by [[axios|Axios]] on the basis of two people briefed on the conversation, tied the company's litigation directly to the removal of one of American cable's highest-rated hosts.[6]

## Puerto Rico primary discrepancies, June 2024

In June 2024, the elections commission of [[puerto-rico|Puerto Rico]] announced it was reviewing its contract with Dominion after hundreds of discrepancies were discovered following the island's June 2 primaries.[7] Interim commission president Jessika Padilla Rivera attributed the problem to a software issue that caused Dominion-supplied machines to incorrectly calculate vote totals.[7] While no party contested the results, machine-reported vote counts were in some cases lower than the paper counts, and some machines reversed certain totals or reported zero votes for particular candidates.[7] Padilla emphasized that with general elections scheduled for November, the island required assurance both that the machines produce a correct result and that the reported result matches it.[7]

More than 6,000 Dominion voting machines were used in the primaries, and the company stated that the software issues stemmed from the digital files used to export results from the machines.[7] Badlands contributor Ashe in America treated that final admission as the critical disclosure, arguing that a corrupted digital export file had altered an election outcome and that the only safeguard against such corruption was, in her phrase, "a pinky promise."[7] The commentary characterized the American election system as highly centralized, holding that centralization creates complexity, complexity breeds and hides corruption, and that centralized complexity had been sold to the public under a false guise of accuracy and security alongside other claims such as "machines can't connect to the internet."[7]

## Continued invocation of Venezuela claims (November 2025)
...
4. Badlands Media — "Badlands News Brief: FOX Guarding the Hen House?", URL: https://badlands.substack.com/p/badlands-news-brief-001
5. Badlands Brief — "Russia's Retreat, Dominion's Domain & Street 'Justice'", URL: https://badlands.substack.com/p/badlands-news-brief-2e7
