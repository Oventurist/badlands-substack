...
The article further observes that the 1864 wartime election introduced mail-in ballots, and that many contemporaries argued the mail-in system was vulnerable to manipulation, allowing fraudulent votes to be cast and potentially altering the outcome — an early instance of the kind of election skepticism the essay defends as constitutionally protected under the [[first-amendment|First Amendment]].
