...
## Role in the pre-October 7 free speech movement

The article "A Glaring Double Standard" names Weiss, alongside Dave Rubin and outlets it labels as "Con INC." (the Daily Wire and the Babylon Bee), among the figures who billed themselves as too liberal to be called conservative but "opposed to cancel culture," advocated for freedom of thought, and rallied against the policing of public discourse — "especially when conservatives were fired from their jobs for expressing their beliefs."

The source quotes at length from Weiss's 2021 op-ed in *Commentary Magazine* titled "[We Got Here Because of Cowardice. We Get Out With Courage](https://www.commentary.org/articles/bari-weiss/resist-woke-revolution/)":
...
The op-ed closes by quoting Douglas Murray: "The problem is not that the sacrificial victim is selected. The problem is that the people who destroy his reputation are permitted to do so by the complicity, silence and slinking away of everybody else."

The author of the article, [[ryan-delarme|Ryan DeLarme]], states he agrees with the final line Weiss included — that if individuals do not defend the rights of others, especially those they disagree with, then "forceful conformity will eventually find its way to you as well."
