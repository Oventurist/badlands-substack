...
updated: 2026-08-02
type: concept
tags: [law, jurisdiction, standing, court-procedure]
...
The article explains that every case begins with *the cause* — the illegal or unlawful act or acts alleged to have occurred — and that what matters is whether the prosecutor or plaintiff can present the proper court with a sufficient amount and type of admissible evidence to support that cause. A cause must satisfy specified criteria, referred to as its *elements*. The source illustrates this with defamation, which requires proof that the defendant intentionally lied, did so maliciously, and that damages resulted. Where a person states something untrue but sincerely believes it to be true, no defamation has occurred.

## Jurisdiction

Bringing a cause also requires the proper venue. The article divides jurisdiction into three components — territorial, personal, and subject matter — and lists the corresponding tests a court applies before a case may proceed: that the acts took place within the proper territory (a dispute between neighbors in Ohio would not be heard in Tennessee); that the acts were committed by an entity over whom the court has jurisdiction, a question of *legal personality* encompassing individuals, courts, partnerships and governments; and that the acts are cognizable by that court, since one would not bring a trillion-dollar suit to a small claims court.
