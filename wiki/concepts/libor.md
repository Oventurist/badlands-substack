...
In a later essay Carlson described LIBOR as the "old, less transparent system" superseded by SOFR, the benchmark created by [[john-c-williams|John C. Williams]] after Trump moved him from the San Francisco Fed to the [[federal-reserve-bank-of-new-york|New York Fed]].[2] He underscored the geopolitical significance of the substitution with a single observation: the "L" in LIBOR stands for London.[2] The replacement is framed as evidence that building a new financial system takes time and proceeds piece by piece.[2]

## Definition and criticism

Carlson defines the London Interbank Offered Rate as a benchmark interest rate at which major global banks lend to one another in the international interbank market for short-term loans.[3] The two things he asks readers to remember about LIBOR are where it comes from — London — and how it is determined — arbitrarily.[3] He contrasts this with [[sofr|SOFR]], which is set from observed, cleared transactions, and argues that a corrupt actor would always prefer an arbitrary and manipulable benchmark to a transparent one.[3]

## End of LIBOR

LIBOR was scheduled to be completely replaced by SOFR on June 30, 2023.[3] Carlson placed this within a broader claim that [[donald-trump|Donald Trump]] sought to replace the [[city-of-london|City of London]]-controlled LIBOR system with a [[federal-reserve|Federal Reserve]]-controlled system, noting that SOFR's architect [[john-c-williams|John C. Williams]] was appointed to the [[federal-reserve-bank-of-new-york|New York Fed]] on April 3, 2018 — the very day SOFR launched.[3]
